...
%%==================================================
%% chapter02.tex for ZSTU Master Thesis
%% based on CASthesis
...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=4cm]{example/zstulogo.png}
  \hspace{1cm}
  \includegraphics[width=4cm]{example/zstulogo.jpg}
...
\begin{figure}[!htp]
  ...
  \subcaptionbox{EPS 图像\label{fig:epspdf:a}}[3cm] %标题的长度，超过则会换行，如下一个小图。
    {\includegraphics[height=2.5cm]{example/zstulogo.eps}}
  \hspace{4em}
  \subcaptionbox{PDF 图像，注意这个图略矮些。如果标题很长的话，它会自动换行\label{fig:epspdf:b}}
    {\includegraphics[height=2cm]{zstulogo.pdf}}
...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=4cm]{zstubadge.pdf}
